...
if __name__ == "__main__":
    ...
    args.add_argument('--mode', type=str, default='train', help='train, test')
    args.add_argument('--gpu_id', default='0', type=str, help='gpu_id')
    args.add_argument('--save_path', type=str, default=None, help='save path')
    args.add_argument('--load_path', type=str, default=None, help='load ckpt path')
    args.add_argument('--log_path', type=str, default=None, help='log path')
    ...
    args.add_argument('--arch', type=str, default='GCN', help='MTL Architecture, option:\
                      ...
                      ')
    ## AL sampling
    args.add_argument('--switch', type=str, default='off', help='switch on/off AL training')
    args.add_argument('--sampling', type=str, default='Random', help='AL sampling, option:\
                      +-------------------------------+\
                      |           AL Sampling         |\
                      +-------------------------------+\
                      |            Random             |\
                      ...
                      +-------------------------------+\
                      ')
    args.add_argument('--n_round', type=float, default=4, help='AL round')
    ...
    ## train
    args.add_argument('--dataset', type=str, default='toxacute', help='dataset')
    ...
    args.add_argument('--epochs', default=50, type=int, help='training epochs')
